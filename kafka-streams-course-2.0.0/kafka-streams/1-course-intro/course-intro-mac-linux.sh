...
# create input topic
bin/kafka-topics.sh --bootstrap-server localhost:9092 --topic streams-plaintext-input --create --partitions 1 --replication-factor 1
...
bin/kafka-topics.sh --bootstrap-server localhost:9092 --topic streams-wordcount-output --create --partitions 1 --replication-factor 1
